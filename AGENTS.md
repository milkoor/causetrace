...
This project is indexed by GitNexus as **causetrace** (1759 symbols, 3003 relationships, 116 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
